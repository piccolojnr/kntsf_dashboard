...
CREATE TABLE `Permit` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `permitCode` VARCHAR(191) NOT NULL,
    ...
    UNIQUE INDEX `Permit_permitCode_key`(`permitCode`),
    UNIQUE INDEX `Permit_originalCode_key`(`originalCode`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Payment` (
    ...
    UNIQUE INDEX `Payment_permitId_key`(`permitId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Permit` ADD CONSTRAINT `Permit_issuedById_fkey` FOREIGN KEY (`issuedById`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
